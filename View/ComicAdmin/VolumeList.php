...
<?php  if($v->authority > 1): ?><a href="#" onclick="linkWithTimeStamp('<?=$v->app_pos?>/ComicAdmin/EditComicVolume?seriesId=<?=$v->series_data['series_id']?>')">EditVolumeData</a><?php endif; ?>
